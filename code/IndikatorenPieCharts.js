...
function drawPiechartHaushalt() {
  ...
  piefilteredData.forEach(function(d) {
    piedata.push({
      Haushalt: 'Einpersonenhaushalte',
      Anzahl: d.Einpersonenhaushalte
    })
    piedata.push({
      Haushalt: 'Paare ohne Kinder',
      Anzahl: d.Paare_ohne_Kinder
    })
    piedata.push({
      Haushalt: 'Paare mit Kinder',
      Anzahl: d.Paare_mit_Kinder
    })
    piedata.push({
      Haushalt: 'Einelternhaushalte',
      Anzahl: d.Einelternhaushalte
    })
    piedata.push({
      Haushalt: 'Andere Haushalte',
      Anzahl: d.Andere_Haushalte
    })
  })
  ...
  function drawPiechartSektoren() {
    ...
    piefilteredData.forEach(function(d) {
      piedata.push({
        Sektor: '1. Sektor',
        Anteil: d.Anteil_Sektor1_2014
      })
      piedata.push({
        Sektor: '2. Sektor',
        Anteil: d.Anteil_Sektor2_2014
      })
      piedata.push({
        Sektor: '3. Sektor',
        Anteil: d.Anteil_Sektor3_2014
      })
